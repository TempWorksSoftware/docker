...
$additionalScopes = @(@{ApiResourceId = 1; Description = "Allow read access to Sovren data"; DisplayName = "Sovren SaaS Read"; Emphasize = 0; Name = "sovrensaas-read"; Required = 0; ShowInDiscoveryDocument = 0;},
                      @{ApiResourceId = 1; Description = "Allow webhook access for Sovren"; DisplayName = "Sovren SaaS Webhook"; Emphasize = 0; Name = "sovrensaas-webhook"; Required = 0; ShowInDiscoveryDocument = 0;},
                      @{ApiResourceId = 1; Description = "Allow write access to Sovren data"; DisplayName = "Sovren SaaS Write"; Emphasize = 0; Name = "sovrensaas-write"; Required = 0; ShowInDiscoveryDocument = 0;},
                      @{ApiResourceId = 1; Description = "Allow read access to Email Accounts and Email Search"; DisplayName = "Email Read"; Emphasize = 0; Name = "email-read"; Required = 0; ShowInDiscoveryDocument = 1;},
                      @{ApiResourceId = 1; Description = "Allow write access to Email Accounts and Email Sending"; DisplayName = "Email Write"; Emphasize = 0; Name = "email-write"; Required = 0; ShowInDiscoveryDocument = 1;})
