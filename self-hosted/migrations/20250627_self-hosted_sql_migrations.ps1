...
$testQuery1 = @"
    ...
    WHERE TABLE_SCHEMA = 'dbo'
        ...
        AND COLUMN_NAME = 'EnableLegacyChangeTracking'
"@;

$sqlMigrationQuery1 = @"
    ALTER TABLE [dbo].[Tenants]
    ADD EnableLegacyChangeTracking BIT NOT NULL
        CONSTRAINT DF_Tenants_EnableLegacyChangeTracking DEFAULT (1)
"@;

Apply-SqlMigration $loginServerConnectionString "Add EnableLegacyChangeTracking column to Tenants table. [WI 126771]" $testQuery1 $sqlMigrationQuery1
